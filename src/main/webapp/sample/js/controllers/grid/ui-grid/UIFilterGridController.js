...
define ([
	...
	function (mainApp){
		...
		mainApp.controller('UIFilterGridController', function($scope,httpFactory,uiGridConstants,dialogs){
			
		console.log('UIFilterGridController Call');
      ...
      $scope.gridOptions = { 
                ...
                columnDefs: [
                  ...
                  { name:'회사', field: 'company', enableFiltering: false},
                  { name:'나이', field: 'age', filters: [
					      {
